...
const ProductDetails = () => {
  ...
  const addToCart = () => {
    dispatch(
      addItemToCart({
        ...
        image: productDetails?.product.images[0].url,
  ...
  const increaseQty = () => {
    ...
    if (count.valueAsNumber >= productDetails?.product.stock) return;
        ...
        <div className="container container-fluid">
          ...
          <div className="row d-flex justify-content-around">
            ...
            <div className="col-12 col-lg-5 mt-5">
              ...
              <p id="product_id">Product # {productDetails?.product._id}</p>
              ...
              <div className="rating-outer">
                <div
                  ...
                  style={{
                    width: `${(productDetails?.product.ratings / 5) * 100}%`,
                  }}
                ></div>
              </div>
              ...
              <p id="product_price">${productDetails?.product.price}</p>
          ...
          {productDetails?.product.reviews &&
            productDetails?.product.reviews.length > 0 && (
              <ListReviews reviews={productDetails?.product.reviews} />
            )}
        </div>
      )}
    </Fragment>
